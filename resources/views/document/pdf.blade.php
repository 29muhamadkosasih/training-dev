    ...
    <main style="margin-left: 30px;margin-right:30px;font-size: 13px;line-height:1.4;">
            ...
            <tbody>
                ...
                @if ($curricula->where('kelompok', 'inti')->count() > 0)
                    <tr class="fw-bold bg-light">
                        <td colspan="2" style="vertical-align: top;text-align:center;font-weight: bold;">Jumlah I
                            (Kelompok Inti)</td>
                ...
                @if ($curricula->where('kelompok', 'penunjang')->count() > 0)
                    <tr class="fw-bold bg-light">
                        <td colspan="2" style="vertical-align: top;text-align:center; font-weight: bold;">Jumlah II
                            (Kelompok Penunjang)</td>
                        <td style="text-align: center;font-weight: bold;">{{ $subtotals['penunjang']['teori'] }}</td>
                        <td style="text-align: center;font-weight: bold;">{{ $subtotals['penunjang']['praktek'] }}</td>
                        <td style="text-align: center;font-weight: bold;">{{ $subtotals['penunjang']['jumlah'] }}</td>
                    </tr>
                @endif
                ...
                @if ($curricula->where('kelompok', '!=', 'ojt')->count() > 0)
                    <tr class="fw-bold bg-light">
                        ...
                        <td style="text-align: center;font-weight: bold;">{{ $subtotals['total']['praktek'] }}</td>
                ...
                @forelse ($curricula->where('kelompok', 'ojt') as $ojt)
                    <tr>
                        ...
                        <td style="vertical-align: top;text-align:left;">On the Job Training (OJT) / Pendampingan</td>
        ...
        @foreach ($sillabus as $item)
            <table class="pdf-table" width="100%"
                style="margin-left:-5px ; border-collapse: collapse; font-size: 13px; line-height:1; border: none;">
                <tbody>
                    <tr>
                        <td width="1%" style="text-align:center;padding:6px;vertical-align:top;border:none;">
                            {{ $loop->iteration }}.
                        </td>
                        <td width="30%" style="text-align:left;padding:6px;vertical-align:top;border:none;">Unit
                            Kompetensi</td>
                        <td width="1%" style="text-align:center;padding:6px;vertical-align:top;border:none;">:
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">Kode Unit</td>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;">:</td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">
                    ...
                    <tr>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;"></td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">Perkiraan Waktu
                            Pelatihan
                        </td>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;">:</td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">
                    ...
                    <tr>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;"></td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">Metode Pelatihan</td>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;">:</td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">
                    ...
                    <tr>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;"></td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">Capaian Unit Kompetensi
                        </td>
                        <td style="text-align:center;padding:6px;vertical-align:top;border:none;">:</td>
                        <td style="text-align:left;padding:6px;vertical-align:top;border:none;">
