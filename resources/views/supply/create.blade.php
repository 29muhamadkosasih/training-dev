        ...
        <div class="col-12 col-lg-12">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Tambah Daftar Perlangkapan yang dibutuhkan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('supplys.store', $document_id) }}" method="POST" id="formSubmit">
                        @csrf
                                            ...
                                            <tr class="item-row">
                                                ...
                                                <td>
                                                    <input type="text" name="items[0][nama_peralatan]"
                                                        ...
                                                        placeholder="Nama Daftar Bahan" required>
    ...
    <script>
        ...
        document.getElementById('addItemBtn').addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                ...
                <td>
                    <input type="text" name="items[${itemCount}][nama_peralatan]"  placeholder="Nama Daftar Bahan"
