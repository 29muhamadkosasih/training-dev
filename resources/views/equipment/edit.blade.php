...
@section('content')
        ...
        <div class="col-12 col-lg-12">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Edit Daftar Peralatan yang digunakan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('equipments.update', ['document_id' => $document_id, 'id' => $equipment->id]) }}" method="POST" id="formSubmit">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="perkiraan_waktu_pelatihan"
                                    ...
                                    placeholder="20 JP @45 menit " value="{{ old('perkiraan_waktu_pelatihan', $equipment->perkiraan_waktu_pelatihan) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="jumlah_peserta"
                                    ...
                                    placeholder="10 Orang (1 Batch)" value="{{ old('jumlah_peserta', $equipment->jumlah_peserta) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="metode_pelatihan"
                                    ...
                                    placeholder="Mis: Luring / Daring / Bauran" value="{{ old('metode_pelatihan', $equipment->metode_pelatihan) }}">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="equipmentTable">
                                        ...
                                        <tbody id="itemsContainer">
                                            @forelse ($equipmentDetails as $index => $detail)
                                                <tr class="item-row">
                                                    <td class="row-number">{{ $index + 1 }}</td>
                                                    <td>
                                                        <input type="text" name="items[{{ $index }}][nama_peralatan]"
                                                    ...
                                                    <td>
                                                        <input type="text" name="items[{{ $index }}][spesifikasi]"
                                                            class="form-control @error('items.' . $index . '.spesifikasi') is-invalid @enderror"
                                                            value="{{ old('items.' . $index . '.spesifikasi', $detail->spesifikasi) }}" placeholder="Spesifikasi"
                                                            required>
                                                    ...
                                                    <td>
                                                        <input type="text" name="items[{{ $index }}][satuan]"
                                                            ...
                                                            value="{{ old('items.' . $index . '.satuan', $detail->satuan) }}" placeholder="Satuan" required>
                                                    ...
                                                    <td>
                                                        <input type="number" name="items[{{ $index }}][jumlah]"
                                                            ...
                                                            value="{{ old('items.' . $index . '.jumlah', $detail->jumlah) }}" min="1"
                                                    ...
                                                    <td style="width: 8%; text-align: center;">
                                                        <button type="button"
                                                            ...
                                                            style="display:{{ count($equipmentDetails) > 1 ? 'inline-block' : 'none' }};">
                                                ...
                                                <tr class="item-row">
                                                    ...
                                                    <td>
                                                        <input type="text" name="items[0][spesifikasi]"
                                                            ...
                                                            value="{{ old('items.0.spesifikasi') }}" placeholder="Spesifikasi"
                                                            required>
                                                    ...
                                                    <td>
                                                        <input type="text" name="items[0][satuan]"
                                                            ...
                                                            value="{{ old('items.0.satuan') }}" placeholder="Satuan" required>
                        ...
                        <div class="row mt-0 text-end ">
                            <div class="col-12">
                                ...
                                <a href="{{ route('equipments.index', $document_id) }}"
    ...
    <script>
        let itemCount = {{ count($equipmentDetails) }};
        ...
        document.getElementById('addItemBtn').addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                ...
                <td>
                    <input type="text" name="items[${itemCount}][nama_peralatan]"  placeholder="Nama Peralatan"
