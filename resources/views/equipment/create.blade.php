        ...
        <div class="col-12 col-lg-12">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Tambah Daftar Peralatan yang digunakan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('equipments.store', $document_id) }}" method="POST" id="formSubmit">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="perkiraan_waktu_pelatihan"
                                    ...
                                    placeholder="20 JP @45 menit " value="{{ old('perkiraan_waktu_pelatihan') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="jumlah_peserta"
                                    ...
                                    placeholder="10 Orang (1 Batch)" value="{{ old('jumlah_peserta') }}">
