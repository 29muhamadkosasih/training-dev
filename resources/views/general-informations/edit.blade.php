        ...
        <div class="col-12 col-lg-12">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Edit Informasi Umum</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('general-informations.update', [$document_id, $generalInformation->id]) }}" id="formSubmit"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-12 mt-1">
                                ...
                                <input type="text" name="kode"
                                    ...
                                    value="{{ old('kode', $generalInformation->kode) }}">
                                @error('kode')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mt-1">
                                ...
                                <input type="text" name="jenis_program"
                                    ...
                                    placeholder="Mis: Cluster / Okupasi / Kualifikasi"
                                    value="{{ old('jenis_program', $generalInformation->jenis_program) }}">
                                @error('jenis_program')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6 mt-1">
                                ...
                                <input type="text" name="metode_pelatihan"
                                    ...
                                    value="{{ old('metode_pelatihan', $generalInformation->metode_pelatihan) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea name="tujuan" class="form-control @error('tujuan') is-invalid @enderror" rows="3"
                                    placeholder="Masukkan tujuan pelatihan...">{{ old('tujuan', $generalInformation->tujuan) }}</textarea>
                                @error('tujuan')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="jenis_standart_kompetensi"
                                    ...
                                    placeholder="Mis: SKNI / SKKNI"
                                    value="{{ old('jenis_standart_kompetensi', $generalInformation->jenis_standart_kompetensi) }}">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <input type="text" name="persyaratan_pendidikan"
                                            ...
                                            value="{{ old('persyaratan_pendidikan', $generalInformation->persyaratan_pendidikan) }}">
                                    ...
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <input type="text" name="persyaratan_pelatihan"
                                            ...
                                            value="{{ old('persyaratan_pelatihan', $generalInformation->persyaratan_pelatihan) }}">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <input type="text" name="persyaratan_pengalaman_kerja"
                                            ...
                                            value="{{ old('persyaratan_pengalaman_kerja', $generalInformation->persyaratan_pengalaman_kerja) }}">
                                    ...
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <input type="text" name="persyaratan_usia"
                                            ...
                                            placeholder="Mis: Minimal 18 tahun"
                                            value="{{ old('persyaratan_usia', $generalInformation->persyaratan_usia) }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <textarea name="persyaratan_khusus_peserta"
                                            ...
                                            placeholder="Masukkan persyaratan khusus...">{{ old('persyaratan_khusus_peserta', $generalInformation->persyaratan_khusus_peserta) }}</textarea>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <textarea name="instruktur_pendidikan_formal"
                                            ...
                                            placeholder="Mis: Minimal tamat D3 atau Sederajat">{{ old('instruktur_pendidikan_formal', $generalInformation->instruktur_pendidikan_formal) }}</textarea>
                                    ...
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <textarea name="instruktur_kompetensi_metodologi"
                                            ...
                                            placeholder="Mis: Identifikasi Kemampuan Metodologi...">{{ old('instruktur_kompetensi_metodologi', $generalInformation->instruktur_kompetensi_metodologi) }}</textarea>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <textarea name="instruktur_kompetensi_teknis"
                                            ...
                                            placeholder="Mis: Memiliki Sertifikasi teknis bidang ...">{{ old('instruktur_kompetensi_teknis', $generalInformation->instruktur_kompetensi_teknis) }}</textarea>
                                    ...
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <textarea name="instruktur_pengalaman_kerja"
                                            ...
                                            placeholder="Mis: Minimal 3 Tahun atau sederajat">{{ old('instruktur_pengalaman_kerja', $generalInformation->instruktur_pengalaman_kerja) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <textarea name="instruktur_persyaratan_khusus"
                                            ...
                                            placeholder="Masukkan persyaratan khusus instruktur...">{{ old('instruktur_persyaratan_khusus', $generalInformation->instruktur_persyaratan_khusus) }}</textarea>
