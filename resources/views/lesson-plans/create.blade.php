        ...
        <div class="col-12 col-lg-12">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Buat Rencana Pelatihan (Lesson Plan)</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('lesson-plans.store', $document_id) }}" method="POST" id="formSubmit">
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $lessonPlans->document->competence->scheme->name }}" disabled>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="number" name="penyajian_hari" id="penyajian_hari"
                                    ...
                                    value="{{ old('penyajian_hari') }}" placeholder="2" min="1" required>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" name="waktu_jp" id="waktu_jp"
                                    ...
                                    value="{{ old('waktu_jp') }}" placeholder="20" min="1" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tujuan_instruksional" id="tujuan_instruksional"
                                class="form-control editor @error('tujuan_instruksional') is-invalid @enderror" rows="4" required>
                                 <p>Setelah mengikuti pelatihan ini peserta kompeten  dalam melaksanakan pekerjaan</p>
                            </textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="metode" id="metode" class="form-control editor @error('metode') is-invalid @enderror" rows="4"
                                required>
                            <p>Ceramah, Diskusi, Demonstrasi</p>
                            </textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="media" id="media" class="form-control editor @error('media') is-invalid @enderror" rows="4"
                                required>
                            <p>Laptop, LCD Projector, Power Point, White Board, Speaker, Flip Chart, Video, Modul</p>
                            </textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="persiapan_text" id="persiapan_text"
                                class="form-control editor @error('persiapan_text') is-invalid @enderror" rows="4" required>
                            <ol>
                                <li>Persiapan ruang kelas</li>
                                <li>Persiapan alat praktek/demonstrasi</li>
                            </ol>
                            </textarea>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary btn-submit">Simpan Rencana Pelatihan</button>
